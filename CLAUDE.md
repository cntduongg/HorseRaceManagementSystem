...
- **Cố ý KHÔNG cascade** (đã cân nhắc rồi loại): hủy giải mà tự hủy luôn race con sẽ kéo [T-28 — hủy race không hoàn cược] lan lên cấp giải, tức xóa suất đua + lời mời hàng loạt trong khi tiền cược của spectator vẫn kẹt. Hủy race là hành động riêng, có ràng buộc riêng (`CancelRaceAsync` chỉ nhận race `Scheduled`).
